...
<div class="col-md-8 col-md-offset-2" style="text-align: center">
    <img src="<?=DIR_REL?>/application/images/portlandlabs_logo.png">
    <br/><br/>
    <form action="<?=$view->action('search')?>" class="tutorial-search-form" data-tutorial-search="<?=$b->getBlockID()?>">
        <input type="hidden" name="audience" value="<?=$audience?>" >
    <input type="hidden" class="input-lg" value="<?php if (is_object($selection)) { ?><?=$selection->id?><?php } ?>" placeholder="" style="padding: 0px; width: 100%"
           name="search" />
        <button type="submit" class="btn-default btn-lg btn"><?=t('Search')?></button>
    </form>
</div>
